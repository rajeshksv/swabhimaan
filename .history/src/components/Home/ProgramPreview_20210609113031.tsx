...
import useIsInViewport from 'react-in-viewport'
...
console.log({isInViewport})
  ...
  return (
    <motion.div ref={targetRef} initial="visible" variants={variants} transition={{duration: 0.3}} initial="hidden" className="my-5">
